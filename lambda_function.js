...
function getRestInfo(intent, session, callback) {
    ...
    const shouldEndSession = false;
    let speechOutput = '';
        speechOutput = "You are looking for information on " + restName.value+ " which hasa rating of " + getRating(restName.value);
        repromptText = "I'm not sure what you are looking for";
    callback(sessionAttributes,
         buildSpeechletResponse(cardTitle, speechOutput, repromptText, shouldEndSession));
